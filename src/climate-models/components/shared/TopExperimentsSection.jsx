...
const TopExperimentsSection = ({ 
            ...
            <div className="bg-white dark:bg-neutral-700 rounded-lg p-6 border border-gray-200 dark:border-neutral-600">
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                    <p className="text-red-600 dark:text-red-400">
                        Error al cargar los datos de experimentos. Por favor, inténtelo de nuevo.
                    </p>
                </div>
            </div>
        );
        ...
        return (
            <div className="bg-white dark:bg-neutral-700 rounded-lg p-6 border border-gray-200 dark:border-neutral-600">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                    No hay datos de experimentos disponibles.
                </p>
            </div>
        );
    }
    ...
    const getModelName = (modelPath) => {
        if (!modelPath) return 'Modelo Desconocido';
        const parts = modelPath.split('/');
        return parts[parts.length - 1] || 'Modelo Desconocido';
    };
        ...
        <div className="bg-white dark:bg-neutral-700 rounded-lg p-6 border border-gray-200 dark:border-neutral-600">
                        ...
                        >
                            ...
                            {topExperiments.length > 0 ? (
                                ...
                                <div className="text-center py-4 text-gray-500 dark:text-gray-400">
                                    ...
                                    <p className="text-sm">No hay experimentos disponibles para este modelo</p>
                                </div>
                            )}
                        </div>
                    );
            ...
            <div className="mt-6 pt-4 border-t border-gray-200 dark:border-neutral-600">
                <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-2">
                    ...
                    Haga clic en cualquier experimento para ver sus detalles completos
                </p>
            </div>
        </div>
    );
